...
git add -A
git commit -m "Round 47: CrossFit guide, venue FAQ, homepage intents" -m "CrossFit editorial, FAQ on 25 top venues, BJJ/CrossFit homepage cards. Asset 442 to 443."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round47 origin/main
git push origin main-pre-round47 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
node scripts\ping-indexnow.js
echo Round 47 SHIPPED.
