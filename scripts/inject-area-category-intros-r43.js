...
const CUSTOM = {
  'central-pattaya|muay-thai': 'The area mapping currently returns five Muay Thai records, but they are not five equivalent walk-in camps: ISS publishes separate gym-access and coached-class prices, Venum and Rage are mapped from South Pattaya/Jomtien-border descriptions, and Petchrungruang and Max include fight or event use. Confirm routine visitor training, class time and the exact map pin before travelling. <a href="/guides/best-gym-central-pattaya/">Central gym guide</a> · <a href="/guides/best-muay-thai-pattaya/">Muay Thai guide</a>.',
  ...
  'east-pattaya|crossfit': 'The former CrossFit Pattaya affiliate is marked departed; Jungle Gym Nong Prue is the current independent functional-fitness record. <a href="/guides/crossfit-pattaya/">CrossFit Pattaya guide</a> · <a href="/guides/best-gym-east-pattaya/">East Pattaya</a>.',
  'east-pattaya|mma': 'The current area mapping returns one MMA-category record, Rambaa Somdet M16 in Nong Prue. Its listing publishes split training periods, but confirm which session covers MMA before travelling. <a href="/guides/bjj-mma-pattaya/">BJJ &amp; MMA guide</a>.',
  ...
  'naklua|climbing': 'Deep Climbing Gym\'s former Harbor Pattaya venue is permanently closed; do not travel to the mall for the old wall. <a href="/guides/climbing-pattaya/">Climbing guide</a>.',
  'east-pattaya|climbing': 'STICKY Climbing Gym in Huai Yai is the current dedicated option, with bouldering and roped climbing but no verified public tariff. <a href="/guides/climbing-pattaya/">Climbing guide</a> · <a href="/guides/best-gym-east-pattaya/">East Pattaya</a>.',
  ...
  'east-pattaya|adventure': 'The mapped options include ATV &amp; Buggy Adventures in Pong and Pattaya Shooting Park on Railway Road; both need their current booking or eligibility terms checked. <a href="/guides/adventure-pattaya/">Adventure guide</a> · <a href="/guides/best-gym-east-pattaya/">East Pattaya</a>.',
  'central-pattaya|kids-youth': 'Harbor Pattaya remains a family-activity location, but the former Deep Climbing venue there is permanently closed. <a href="/guides/kids-youth-sport-pattaya/">Kids &amp; youth sport</a> · <a href="/guides/climbing-pattaya/">Climbing status</a>.',
  ...
  'central-pattaya|clubs': 'Pattaya Hash House Harriers and Pattaya Sports Club anchor central social sport — Monday runs and 3rd Road events. Pool nights at SF Strike and Megabreak. <a href="/guides/running-cycling-clubs-pattaya/">Running &amp; cycling clubs</a> · <a href="/guides/snooker-pool-billiards-pattaya/">Pool &amp; snooker</a>.',
