...
`venue-outreach.csv` has three ready columns for each of the 104 venues
with websites:
...
```html
<a href="https://pattaya-gym.com/" title="Pattaya.Gym — independent Pattaya sport directory"><img src="https://pattaya-gym.com/badge-listed.svg" alt="Listed on Pattaya.Gym" width="180" height="44" loading="lazy"></a>
```
