...
const CATEGORY_EDITORIAL = {
  ...
  'bjj': `
      <p><strong>If you only read one thing: the single result below is closed.</strong> The BJJ category contains one directory record as checked on 26 July 2026: <a href="/gyms/alfa-bjj-pattaya/">ALFA BJJ Pattaya</a>, a former Soi Khopai academy whose exact Maps listing is permanently closed. It is retained as a closure finding, not a recommendation. Active BJJ and grappling programmes exist in Pattaya, but the relevant venues are currently filed under their primary fitness or combat-sport categories.</p>
...
const AREA_CONTENT = {
  'jomtien': {
    ...
    intro: `<p><strong>If you only read one thing: this page is a 39-record regional filter, not a list of 39 confirmed venues within walking distance of Jomtien Beach.</strong> As checked on 26 July 2026, it returns 10 sport categories: 8 watersports records, 8 fitness, 5 racquet, 5 clubs, 4 swimming, 3 Muay Thai, 2 yoga, 2 kids and youth, 1 golf and 1 adventure record. The matching rule also captures addresses labelled Thepprasit, Na Jomtien and farther south toward Sattahip. Open each map before choosing accommodation or paying for a booking.</p>
      ...
      <p><a href="/gyms/jomtien-dive-center/">Jomtien Dive Center</a> listed certified-diver day trips from ฿2,800 for Pattaya and ฿3,200 for Samae San on 25 July 2026. Its page says equipment other than a dive computer, a qualified guide, lunch, refreshments and pickup within five kilometres are included. This is a full-day booked activity, not an hourly beach rental. At the other end of the commitment scale, <a href="/gyms/better-bodies-gym-na-jomtien/">Better Bodies Gym</a> published ฿2,500 for three months or ฿4,500 for six months paid in advance on the same date, but no drop-in price.</p>
  ...
  'central-pattaya': {
    ...
    intro: `<p><strong>Central Pattaya is a mixed 45-record index, not a promise of 45 open gyms.</strong> The first-match area rule currently returns 13 fitness records, six clubs, six watersports records, five Muay Thai records, four racquet records, four kids-and-youth records, three swimming records, two adventure records and one each for MMA and golf. Diamond Badminton and JUMPZ Harbor Pattaya are closed; Platinum Fitness, BOUNCE Pattaya and Pattaya Beach Aerobics are unverified; Pattaya Floating Market is explicitly non-sport. Those six status findings remain visible because an honest directory should not turn every location match into a recommendation. Records whose area names first match Jomtien, Naklua or Pratamnak stay in those more specific filters even when their text also mentions South or Central Pattaya.</p>
      ...
      <p><a href="/gyms/hard-rock-pool/">Hard Rock Hotel Pattaya Pool</a> is a 2,000-square-metre freeform leisure product rather than a documented lap-training pool. Its operator page checked on 26 July 2026 lists the pool itself from 07:00 to 21:00 and non-resident access from 09:00 to 19:00. The current tariff is ฿500 net per adult including one selected cocktail and ฿400 net per child under 12 including one fruit punch; tube hire starts at ฿200 net per day. The operator describes cabanas for a maximum of four people or one family but does not publish a current cabana price. <a href="/gyms/nara-maze-pool-day-pass/">Nara Maze</a> published a different ฿500 net non-resident product on 24 July, including access from 09:00 to 18:00, water, a smoothie and a food-and-drink discount. Nara Maze does not appear in the Central area filter because its more specific Naklua area name matches first, but it is a useful current non-guest alternative. The equal headline price does not make the location, eligibility, hours or inclusions equal.</p>
