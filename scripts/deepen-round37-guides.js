...
const GUIDES = [
  {
    ...
    lede: 'Choose the exact beginner product, not a gym reputation. This guide compares explicit level claims, current prices, session formats and timetable evidence, then marks the gaps that still need a direct answer.',
  ...
  },
  {
    ...
    lede: 'Choose the exact transaction before the destination. This comparison matches current group, weekly, monthly, private and residential examples without turning a few operator prices into a city-wide verdict.',
