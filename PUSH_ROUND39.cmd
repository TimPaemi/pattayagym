...
git add -A
git commit -m "Round 39: 1 week vs 1 month Muay Thai training guide" -m "train-muay-thai-pattaya-1-week-1-month editorial guide plus hub and homepage intent links. Asset 434 to 435."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round39 origin/main
git push origin main-pre-round39 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
echo Round 39 SHIPPED.
