...
priceRange: ฿฿
description: Pattaya's most respected pool and snooker hall. Tournament-class 9-foot pool tables, professional setting, modern playing arena. Long-running expat favourite — frequently cited as the best pool facility in the city.
tags:
  - pool
  - snooker
  - billiards
  ...
  - soi-diana
  - expat-favourite
mapsUrl: https://maps.google.com/?q=Megabreak+Pool+Hall+Pattaya
verified: 2026-04-29
---
...
| Field | Detail |
|-------|--------|
| Category | Cue sports — pool + snooker |
| Address | Soi Diana (Soi 13), off Second Road, Pattaya |
| Hours | Daily — typically late afternoon to late night |
| Price | ฿฿ — table hire per hour |
| Tables | Tournament-class 9-foot pool + snooker |
| Atmosphere | Focused, serious play |
| Membership | None — walk-in pricing |
| Languages | English (primary), Thai |
| Best for | Serious cue-sport players |
| Walking distance to Beach Road | Yes — 5–8 min |
