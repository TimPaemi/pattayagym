module.exports = `
<p><strong>If you only read one thing:</strong> the three phrases that solve most first-day friction are <strong>sawatdee khrap/kha</strong> (hello), <strong>train dai mai</strong> (can I train?) and <strong>ra kha tao rai</strong> (how much?). The directory includes both English-language booking pages and contact-first venues, so a few Thai words can make price checks, directions and sparring boundaries clearer.</p>

<p>This guide is a field sheet, not a language course. Use it with the <a href="/guides/muay-thai-pattaya-beginners/">Muay Thai beginners guide</a>, the <a href="/guides/english-speaking-muay-thai-pattaya/">English-speaking camps guide</a> and the <a href="/guides/gym-day-pass-pattaya/">gym day-pass guide</a> when you are choosing between a tourist-friendly class and a contact-first local gym. Keep the <a href="/gyms/fairtex-pattaya/">Fairtex</a>, <a href="/gyms/sityodtong-pattaya/">Sityodtong</a>, <a href="/gyms/battle-conquer-gym/">Battle &amp; Conquer</a> and <a href="/gyms/sudsakorn-muay-thai-gym/">Sudsakorn</a> records open when you need the venue-specific evidence behind the questions.</p>

<h2>The phrases that matter most in a Pattaya gym</h2>
...
<h2>Why this matters more in contact-first gyms</h2>

<p>Pattaya has several gyms with clean English-language booking pages, but many confirmed operating venues still need a direct message for the exact class, price or equipment list. That is why these phrases matter more than perfect pronunciation. At a transparent gym such as <a href="/gyms/wko-muay-thai/">ISS Boxing and Muay Thai</a>, you may only need Thai for greetings and directions because the class product is already named. At a contact-first camp such as <a href="/gyms/o-sansuk-muay-thai-gym/">O. Sansuk Muay Thai Gym</a> or <a href="/gyms/sitpholek-muay-thai/">Sitpholek</a>, a simple message or desk conversation has to answer the real planning questions: can you join, which session, how much, what to bring and whether sparring is optional.</p>

<p>This is also why mixed Thai and English is normal. Many gyms understand <strong>day pass</strong>, <strong>private</strong>, <strong>gloves</strong>, <strong>clinch</strong> and <strong>spar</strong> more quickly than a forced textbook translation. Use the Thai where it removes friction, not as a performance. A polite <strong>sawatdee</strong> followed by simple English and one or two Thai keywords is often the fastest route to a useful answer.</p>
...
<h3>Do I need Thai to train at a Pattaya Muay Thai gym?</h3>
<p>Usually no for the session itself, especially at gyms with strong foreign-student traffic. Thai helps most when the venue is contact-first, when the public timetable is unclear, or when you need to ask about price, gear or sparring boundaries. Start with <a href="/guides/english-speaking-muay-thai-pattaya/">English-speaking camps</a> if language support is the main filter.</p>

<h3>What should I say on my first day?</h3>
<p>Use <strong>sawatdee khrap/kha</strong>, then <strong>train dai mai</strong>, then <strong>long krang raek</strong>. That sequence politely says hello, asks whether you can join and makes clear that it is your first visit. After that, ask <strong>ra kha tao rai</strong> and confirm gloves, wraps and session type.</p>

<h3>How do I ask for light or no sparring?</h3>
<p><strong>Bao bao</strong> is the most useful phrase for light contact. If you do not want sparring at all, <strong>mai spar</strong> is widely understood in Pattaya gyms even though it is mixed Thai-English. Pair it with clear body language and say it before the round starts, not after contact escalates.</p>
`;
