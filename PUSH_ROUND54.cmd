...
git add -A
git commit -m "Round 54: Running and cycling clubs guide, social sport mesh" -m "Clubs editorial, hash, beach aerobics, team sport. Asset 449 to 450."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round54 origin/main
git push origin main-pre-round54 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
node scripts\ping-indexnow.js
echo Round 54 SHIPPED.
