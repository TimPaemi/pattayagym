...
git add -A
git commit -m "Round 48: Swimming guide, venue FAQ all 158" -m "Swimming editorial, FAQ on every venue page, improved schema. Asset 443 to 444."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round48 origin/main
git push origin main-pre-round48 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
node scripts\ping-indexnow.js
echo Round 48 SHIPPED.
