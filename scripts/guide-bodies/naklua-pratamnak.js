module.exports = `
<p><strong>Naklua and Pratamnak are separate training bases, not one compact neighbourhood.</strong> Naklua is the north-Pattaya and Wong Amat side; Pratamnak is the hill between central Pattaya and Jomtien. The directory combines them in this guide because both suit readers choosing accommodation outside the central nightlife corridor, not because a gym on one side is automatically convenient from the other.</p>

<p>As checked on 26 July 2026, the <a href="/area/naklua/">Naklua filter</a> contains 24 records across ten sport categories. The <a href="/area/pratamnak/">Pratamnak filter</a> contains 13 records across six categories. Those totals are records, not recommendations or public day passes. Naklua includes three unverified identities and one non-sport attraction; Pratamnak has no closure or verification warning in the current dataset, but several of its cleanly identified records are hotel or member facilities rather than public gyms.</p>
...
<h2>Current products with a public price</h2>

<table>
<thead><tr><th>Record</th><th>Access product</th><th>Published price checked</th><th>Main caveat</th></tr></thead>
<tbody>
<tr><td><a href="/gyms/fairtex-pattaya/">Fairtex Training Center</a></td><td>Muay Thai training</td><td>฿800 one session; ฿7,000 for ten; ฿16,500 unlimited month</td><td>Confirm the exact programme and class time</td></tr>
<tr><td><a href="/gyms/battle-conquer-gym/">Battle &amp; Conquer</a></td><td>Gym or Muay Thai</td><td>฿200 gym day; ฿500 group Muay Thai; ฿2,500 one week of Muay Thai</td><td>The products include different facilities</td></tr>
<tr><td><a href="/gyms/fitz-club/">Fitz Club</a></td><td>Outside-guest facilities pass</td><td>฿800 adult; ฿400 child under 12</td><td>Pass excludes tennis and squash</td></tr>
<tr><td><a href="/gyms/ashtanga-yoga-pattaya/">Ashtanga Yoga Pattaya</a></td><td>Group practice</td><td>฿300 drop-in; ฿1,000 four classes; ฿2,500 unlimited month</td><td>Published windows are not continuous reception</td></tr>
<tr><td><a href="/gyms/play-padel-pattaya/">Play Padel</a></td><td>Indoor court</td><td>฿1,200 per court-hour; coaching from ฿600; racket ฿100</td><td>App prepayment and cancellation terms apply</td></tr>
<tr><td><a href="/gyms/nara-maze-pool-day-pass/">Nara Maze</a></td><td>Non-resident leisure-pool day</td><td>฿500 net</td><td>Not a lap-training or hotel-gym pass</td></tr>
</tbody>
</table>
...
<p><a href="/gyms/anytime-fitness-pattaya/">Anytime Fitness Pattaya</a> is one record covering two branches. The Again Pattaya branch is in Naklua, while Bukis Point is in South Pattaya. Both publish 24-hour member access, but prices, staffed hours and first-visit arrangements vary. Ask about the exact branch, joining or key fees, minimum term, trial access and whether a membership from another country activates immediately. Round-the-clock member access does not mean a visitor can register at every hour.</p>
...
<p><a href="/gyms/one-d-yoga-studio/">ONE-D YOGA PATTAYA</a> is a current Wong Amat studio with a 09:00-10:30 morning window and evening periods on several days. Those Maps hours are not a class-by-class timetable, and no current operator tariff was found. Message the studio with the date, experience level and preferred style rather than arriving at the start of a general operating period.</p>
...
<h2>Pratamnak: priced Muay Thai and public strength options</h2>

<p><a href="/gyms/battle-conquer-gym/">Battle &amp; Conquer</a> is the most transparent Pratamnak combat-and-fitness record. It publishes group Muay Thai daily from 08:00 to 10:00 and 16:00 to 18:00. The ฿500 single group session and weekly or monthly Muay Thai packages include access to the boxing room, weights gym, sauna and cold plunge. Gym-only access is separately priced at ฿200 for one day, ฿600 for one week and ฿1,300 for one month. Compare the named product rather than assuming the lowest amount covers coaching and recovery facilities.</p>

<p><a href="/gyms/muscle-factory-pattaya/">Muscle Factory Pattaya</a> is a current independent fitness centre on Pratamnak Road, open daily from 07:00 to 22:00. Its live public evidence supports strength equipment and group exercise, but not the former claims about building size, specialist platforms, air conditioning or old membership amounts. <a href="/gyms/human-strong-gym-pattaya/">Human Strong Gym Pattaya</a> publishes free weights, resistance machines, cardio, Muay Thai and boxing, with weekday hours of 07:00-22:00 and weekend hours of 08:00-22:00. Neither has a stable current public tariff in the dataset. Contact the gym when a particular machine, coached format or short-term pass is essential.</p>

<p><a href="/gyms/pratumnak-fitness-park/">Pratumnak Fitness Park</a> is a different product again. Pattaya City material records a walking and running surface, multipurpose court and 12 outdoor exercise stations at Chaloem Phrakiat Park. No current municipal tariff or formal daily schedule is published. The site suits self-directed outdoor training; it does not promise air conditioning, lockers, showers, a verified barbell setup or staffed supervision.</p>

<h2>Pratamnak racquets and yoga</h2>

<p><a href="/gyms/fitz-club/">Fitz Club</a> is the most complete outside-guest sports-club product. The ฿800 adult day pass covers the gym, pool, sauna and steam rooms but excludes tennis and squash. The club separately publishes seven tennis courts, two squash courts, a multipurpose court, table tennis and coaching. Gym, class, sauna and steam hours are 07:00-21:00; courts and pool close at 20:00. Reserve court hire or coaching rather than assuming the day pass covers it.</p>

<p><a href="/gyms/play-padel-pattaya/">Play Padel</a> is the clear price-led indoor-court option. Its ฿1,200 tariff is per court-hour, not per person, and private coaching begins at ฿600 per hour. New players booking in advance may need to prepay through the Padelmates flow; card payment in the app adds ฿100. <a href="/gyms/pickleball-pattaya/">PR Pattaya Pickleball</a> is the current identity for the former Pickleball Pattaya location. Maps shows morning and late-afternoon playing windows, but no stable current tariff. Ask about open play, partner matching, equipment and whether a slot must be reserved.</p>

<p>For yoga, <a href="/gyms/ashtanga-yoga-pattaya/">Ashtanga Yoga Pattaya</a> offers the clearest dated tariff and publishes practice windows rather than all-day reception. <a href="/gyms/balance-yoga-studio-pattaya/">Balance Yoga Studio</a> listed a group yoga class at ฿500 and a group sound-healing session at ฿1,000 on 25 July. Its public timetable still showed February 2026 when checked, so book the specific class and confirm access to the condominium building before arrival.</p>

<h2>Sailing and resort records on Pratamnak</h2>

<p><a href="/gyms/royal-varuna-yacht-club/">Royal Varuna Yacht Club</a> is a member sailing club and RYA-accredited training centre. Its 2026 programme supports youth and adult sailing, private tuition, powerboat and instructor training, but the public pages checked did not publish current membership or course amounts. Training can be enquired about without treating the club as a walk-in beach rental. Confirm whether a course includes use of the pool, lawn, beachfront, restaurant or other member facilities.</p>

<p><a href="/gyms/cross-pattaya-pratamnak/">Cross Pattaya Pratamnak</a> publishes a Cloud Club with treadmills, exercise bicycles and a yoga area from 06:00 to 22:00, plus saltwater pools from 07:00 to 20:00. The current site presents these as hotel activities and does not publish a non-resident day pass. <a href="/gyms/intercontinental-pattaya/">InterContinental Pattaya</a> likewise confirms a hotel fitness centre, three leisure pools and a spa but no public gym ticket or current fitness-centre hours. Treat both as accommodation amenities unless the hotel gives a written non-resident offer for the chosen date.</p>
...
<p>Use the <a href="/compare/">comparison tool</a> to keep access model, hours and dated price attached to each record. For alternatives outside these two districts, compare the <a href="/guides/best-gym-central-pattaya/">Central Pattaya guide</a> and the <a href="/guides/best-gym-jomtien-pattaya/">Jomtien guide</a>. The right result is the product you can actually access at the exact pin, not the venue with the longest feature list.</p>
