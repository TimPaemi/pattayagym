@echo off
REM Round 79 — attractions, dive, golf, circuit phones
cd /d "%~dp0"
...
git add -A
git commit -m "Round 79: +8 venue phones; telephone gate 77" -m "Nong Nooch, Dragon Shooting, Underwater World, Sanctuary of Truth, Dive Station, Bira, Greenwood, Manta Kids."
if errorlevel 1 echo Nothing to commit
git push origin main || exit /b 1
echo Round 79 SHIPPED.
