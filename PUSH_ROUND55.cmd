...
git add -A
git commit -m "Round 55: Equestrian and polo guide, Mabprachan mesh" -m "Equestrian editorial, Horseshoe vs Thai Polo. Asset 450 to 451."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round55 origin/main
git push origin main-pre-round55 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
node scripts\ping-indexnow.js
echo Round 55 SHIPPED.
