...
git add -A
git commit -m "Round 44: East Pattaya guide and ranked deepen" -m "Darkside area hub plus deepen beginners family female guides. Asset 439 to 440."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round44 origin/main
git push origin main-pre-round44 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
echo Round 44 SHIPPED.
