...
git add -A
git commit -m "Round 37: beginners, Jomtien, Pattaya vs Phuket SEO guides" -m "Three editorial guides plus hub and homepage intent updates. Asset 432 to 433."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round37 origin/main
git push origin main-pre-round37 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
echo Round 37 SHIPPED.
