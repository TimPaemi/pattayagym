...
const ROUNDS = [
  {
    n: 107, date: '2026-06-12', tag: `v${ASSET_VERSION}`,
    title: 'TimPaemi author entity + Pattaya After Dark joins the network',
    summary: 'Every guide now attributes to the canonical TimPaemi (timpaemi.com) Person entity — schema author with photo, alternateName, and network-wide sameAs. Pattaya After Dark added to footer, network blocks, and Organization schema site-wide.',
    bullets: [
      'scripts/lib/timpaemi-author.js — single Person entity (@id timpaemi.com/#timpaemi) used by Article schema on all 47 guides, about page, and homepage @graph.',
      'Guide bylines now read "By TimPaemi" linking to timpaemi.com with rel=author; meta name=author added on guides.',
      '/authors/timpaemi.jpg deployed (512px) — author photo in schema + about page.',
      'Pattaya After Dark (pattaya-afterdark.com) — footer Projects column, PA network block, homepage cards, Organization sameAs.',
    ],
  },
  {
    n: 105, date: '2026-06-09', tag: 'v467',
