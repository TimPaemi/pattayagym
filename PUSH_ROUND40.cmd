@echo off
REM Round 40 — Naklua & Pratamnak area guide + editorial funnel on ranked guides
cd /d "%~dp0"
if exist .git\index.lock del /f /q .git\index.lock
for /f "tokens=*" %%i in ('git rev-parse --abbrev-ref HEAD') do set BRANCH=%%i
if not "%BRANCH%"=="redesign-2026" (echo Not on redesign-2026 & exit /b 1)
call npm install --silent || exit /b 1
node scripts\write-round40-guide.js || exit /b 1
...
git add -A
git commit -m "Round 40: Naklua Pratamnak guide and editorial funnel links" -m "best-gym-naklua-pratamnak-pattaya editorial guide plus ranked guide funnel to beginners and trip-length content. Asset 435 to 436."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round40 origin/main
git push origin main-pre-round40 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
echo Round 40 SHIPPED.
