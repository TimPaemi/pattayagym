...
node scripts\deepen-round57-ranked.js || exit /b 1
...
git add -A
git commit -m "Round 57: Snooker mesh, Russian-speaking deepen, audit script" -m "Pool and snooker guide meshed. Rusich and AF Academy deepen. Asset 451 to 452."
if errorlevel 1 echo Nothing to commit
git push origin redesign-2026 || exit /b 1
git tag -f main-pre-round57 origin/main
git push origin main-pre-round57 --force
git push origin redesign-2026:main || exit /b 1
node scripts\ping-sitemap.js
node scripts\ping-indexnow.js
echo Round 57 SHIPPED.
