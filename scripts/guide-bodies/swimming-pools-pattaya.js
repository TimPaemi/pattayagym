module.exports = `
<p><strong>If you only read one thing:</strong> Pattaya swimming is not one market. The current directory evidence splits into <strong>municipal public pools</strong>, <strong>hotel non-guest pool passes</strong>, <strong>hotel pools with no current public pass</strong>, and <strong>full-day water parks</strong>. Start by choosing the access model, not the prettiest photo.</p>

<p>This guide uses only the current venue records in our <a href="/category/swimming/">swimming category</a>. For a lane-first plan, compare municipal pools before paying hotel rates. For a leisure day, compare explicit non-guest passes before assuming every hotel pool sells one.</p>

<h2>How the current swimming options differ</h2>
...
<table>
  <thead>
    <tr>
      ...
      <th>What is publicly priced now</th>
      <th>Main caution</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><a href="/gyms/nong-prue-municipal-swimming-pool/">Nong Prue Municipal Swimming Pool</a></td>
      <td>Municipal public pool</td>
      <td>Tue-Fri 10:00-20:00; Sat-Sun and public holidays 09:00-20:00; Mon closed</td>
      <td>No stable public tariff found</td>
      <td>Check council notices for closures before travelling</td>
    </tr>
    <tr>
      <td><a href="/gyms/hard-rock-pool/">Hard Rock Hotel Pattaya Pool</a></td>
      <td>Hotel non-guest day pass</td>
      <td>Pool daily 07:00-21:00; non-guest access 09:00-19:00</td>
      <td>THB 500 adult; THB 400 child under 12</td>
      <td>Leisure pool, not a documented lap-training product</td>
    </tr>
    <tr>
      <td><a href="/gyms/nara-maze-pool-day-pass/">Nara Maze Pool Day Pass at Terra Nara</a></td>
      <td>Hotel non-guest day pass</td>
      <td>Daily 09:00-18:00</td>
      <td>THB 500 net including water, one smoothie and 20% off food and drinks excluding alcohol</td>
      <td>No lane-length or training-lane evidence published</td>
    </tr>
    <tr>
      <td><a href="/gyms/cross-pattaya-pratamnak/">Cross Pattaya Pratamnak — Cloud Club</a></td>
      <td>Hotel amenity</td>
      <td>Cloud Club 06:00-22:00; pools 07:00-20:00</td>
      <td>No current public non-resident pass found</td>
      <td>Do not infer outside access from hotel amenity pages</td>
    </tr>
    <tr>
      <td><a href="/gyms/ramayana-water-park/">Ramayana Water Park Pattaya</a></td>
      <td>Full-day water park</td>
      <td>11:00-18:00 except Wednesday closed</td>
      <td>THB 1,099 online or THB 1,199 walk-in for guests at least 106 cm tall</td>
      <td>Family attraction, not a short lap-swim substitute</td>
    </tr>
  </tbody>
</table>
...
<p><a href="/gyms/cross-pattaya-pratamnak/">Cross Pattaya Pratamnak — Cloud Club</a> is the clean example. The current operator pages support the Cloud Club hours, the pool hours, the saltwater-pool setup and the possibility of arranging private yoga or a personal trainer with notice. None of that establishes a current public non-resident day pass. The record is therefore a confirmed hotel wellness amenity, not an open invitation for outside swimmers.</p>

<p>This distinction matters because Pattaya hotel research often produces attractive facilities faster than it produces access terms. A pool page can prove that a facility exists while still failing to prove eligibility for a walk-in visitor. The directory is more accurate when it keeps that boundary visible than when it silently upgrades “published amenity” into “public day pass.”</p>

<h2>Water parks are a different purchase from pools</h2>
...
<p>Central, Pratamnak, East Pattaya and Na Jomtien are useful for transport planning, but the access model is the first filter. A central hotel pass may still be a worse fit than a farther pool if the goal is routine laps. A south-side water park may still be the right answer if the group needs a full family day. Start with the transaction type, then shortlist by location. The <a href="/compare/">compare tool</a> and the <a href="/map/">map</a> help only after the product itself is clear.</p>
...
<p><a href="/guides/hotel-gym-pattaya/">Hotel gym day passes</a> · <a href="/guides/family-friendly-pattaya/">Family-friendly sport</a> · <a href="/guides/best-gym-sattahip-pattaya/">Na Jomtien &amp; Sattahip</a> · <a href="/guides/">All guides</a></p>
`;
