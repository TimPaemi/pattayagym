...
address: "Various weekly run starting points around Pattaya — confirm via website"
phone: ""
website: https://www.pattayah3.com/
social:
  facebook: "groups/308747049238960"
  youtube: UCgR_iYYiVABQEpJrx_grt3A
hours: "Run every Monday afternoon — 'On On' meeting / circle follows the run"
priceRange: ฿
distinction: First Hash in Pattaya — running every Monday since 1984
founded: 1984
parentMovement: Hash House Harriers (founded 1938 in Kuala Lumpur)
runFrequency: Weekly Monday runs (all year)
beginnerFriendly: true
languages: [English, Thai]
verified: 2026-04-27
sources:
  - https://www.pattayah3.com/
  - https://www.facebook.com/groups/308747049238960/
  - https://www.youtube.com/channel/UCgR_iYYiVABQEpJrx_grt3A/featured
...
| Hash | Run Day | Established | Style |
|---|---|---|---|
| **Pattaya Hash House Harriers (PH3)** | **Monday** | **1984** | **Mixed mainstream — original** |
| **Pattaya Jungle Hash** | Sunday | Later | Off-road / jungle-focused |
| **Pattaya Monkey Hash** | Saturday | Later | Bi-weekly / social |
| Various Bangkok hashes | Various | 1977+ | Day trips, joint runs |
...
| Field | Value |
|---|---|
| Founded | 1984 — first Hash in Pattaya |
| Run day | Every Monday |
| Run format | Paper trail run (5-10 km) + circle + meal |
| Visitor fee | ~฿200-300 per run |
| Website | pattayah3.com |
| Parent movement | Hash House Harriers (1938, Kuala Lumpur) |
| Sister hashes | Pattaya Jungle Hash (Sun), Pattaya Monkey Hash (Sat) |
